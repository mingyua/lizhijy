...
<div class="container-layout">
 ...
 <ul class="padding-top">
			<?php
			$about=new M("cate");
			$val=$about->select("pid='30'  and window='1'");
			foreach($val as $v){
			?>
               <li class="leftli" style="padding:5px 0;text-align:center;"><a href="zhaos.php?cid=<?php echo $v['id']?>"><?php echo $v['name']?></a></li>
 			<?php	
			}
			?>
...
$about=new M("single");
if($cid==null){
$val=$about->find("kinds='31'");
$cname=$cate->find("id='31'");
