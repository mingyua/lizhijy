   ...
   <form method="post">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover">
			...
			$articles=new M('single');
            $result=$articles->select("kinds<>0 order by sort desc");
            ...
            <tr>
				...
				<td><a href="single_add.php?id=<?php echo $k['id']?>"><span class="icon-edit text-blue"></span></a> <a href="single_del.php?id=<?php echo $k['id']?>" onclick="{if(confirm('确认删除?')){return true;}return false;}"><span class="icon-trash-o text-red"></span></a>
				</td>
			</tr>
			<?php
			}
