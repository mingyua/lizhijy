...
<div class="container-layout">
 ...
 <ul class="padding-top">
			<?php
			$about=new M("cate");
			$val=$about->select("pid='18'  and window='1'");
			foreach($val as $v){
			?>
                <li class="leftli" style="padding:5px 0;text-align:center;"><a href="case.php?cid=<?php echo $v['id']?>"><?php echo $v['name']?></a></li>
 			<?php	
			}
			?>
...
if($cid==null){
$val=$article->select("kinds='19'");
$cname=$cate->find("id='19'");
$where="kinds=19";
}else{
