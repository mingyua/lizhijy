...
<div class="container-layout">
 ...
 <ul class="padding-top">
			<?php
			$about=new M("cate");
			$val=$about->select("pid='23' and window='1'");
			foreach($val as $v){
			?>
                <li class="leftli" style="padding:5px 0;text-align:center;"><a href="news.php?cid=<?php echo $v['id']?>"><?php echo $v['name']?></a></li>
 			<?php	
			}
			?>
...
if($cid==null){
$val=$article->select("kinds='24'");
$cname=$cate->find("id='24'");
$where="kinds=24";
}else{
...
?>
	...
	<li><span class="date" style='float:right'><?php echo date('Y-m-d H:i',$k['time']) ?></span><a href="show.php?cid=<?php echo $k['kinds']?>&id=<?php echo $k['id']?>" target="_blank" ><?php echo $k['title']?></a></li>
