...
<div class="container-layout">
 ...
 <ul class="padding-top">
			<?php
			$about=new M("cate");
			$val=$about->select("pid='7' and window='1'");
			foreach($val as $v){
			?>
                <li class="leftli" style="padding:5px 0;text-align:center;"><a href="study.php?cid=<?php echo $v['id']?>"><?php echo $v['name']?></a></li>
 			<?php	
			}
			?>
...
if($cid==null){
$val=$article->select("kinds='8'");
$cname=$cate->find("id='8'");
$where="kinds=8";
}else{
