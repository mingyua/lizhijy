...
<div class="container-layout">
 ...
 <ul class="padding-top">
			<?php
			$about=new M("cate");
			$val=$about->select("pid='1' and window='1'");
			foreach($val as $v){
			?>
                <li style="padding:5px 0;text-align:center"><a href="about.php?cid=<?php echo $v['id']?>"><?php echo $v['name']?></a></li>
 			<?php	
			}
			?>
...
$about=new M("single");
if($cid==null){
$val=$about->find("kinds='2'");
$cname=$cate->find("id='2'");
